    ...
    private void consume() throws InterruptedException {
        ...
        while (bufferCondiviso.isEmpty()) {
            synchronized (bufferCondiviso) {
                System.out.println("Il buffer è vuoto, "+Thread.currentThread().getName()+" resta in attesa... la dimensione del buffer adesso è: " + bufferCondiviso.size());
        ...
        synchronized (bufferCondiviso) {
        	System.out.println(Thread.currentThread().getName()+" sta leggendo il buffer ed eliminando il seguente elemento: " + bufferCondiviso.remove(0) + " la dimensione del buffer adesso è: " + bufferCondiviso.size());
